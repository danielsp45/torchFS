...
class Status {
  public:
    ...
    bool is_not_found() const { return code_ == kNotFound; }
    bool is_already_exists() const { return code_ == kAlreadyExists; }
    bool is_corruption() const { return code_ == kCorruption; }
    bool is_invalid_argument() const { return code_ == kInvalidArgument; }
    bool is_io_error() const { return code_ == kIOError; }
    bool is_internal_error() const { return code_ == kInternalError; }
    ...
    static Status AlreadyExists(const std::string &msg) {
        return Status(kAlreadyExists, msg);
    }
    ...
    static Status InternalError(const std::string &msg) {
        return Status(kInternalError, msg);
    }
